...
let
  wallpaper = builtins.fetchurl {
    url =
      "https://c.wallhere.com/photos/af/ad/Linux_Nixos_operating_system_minimalism-2175185.jpg!d";
  ...
  wayland.windowManager.sway = {
    ...
    config = rec {
      ...
      keybindings = {
        ...
        "${modifier}+e" =
          "exec ${pkgs.foot}/bin/footclient ${pkgs.yazi}/bin/yazi";
        ...
        "${modifier}+Shift+T" =
          "exec ${pkgs.obs-cmd}/bin/obs-cmd  replay toggle";
        "${modifier}+Shift+G" = "exec ${pkgs.obs-cmd}/bin/obs-cmd  replay save";

        "${modifier}+d" =
          "exec ${pkgs.rofi}/bin/rofi -show drun -show-icons | ${pkgs.findutils}/bin/xargs swaymsg exec --";
        "${modifier}+q" = "kill";
      ...
      startup = [
        ...
        {
          command =
            "${pkgs.toybox}/bin/ls ~/Pictures/walls/ | ${pkgs.toybox}/bin/shuf -n 1 | ${pkgs.toybox}/bin/xargs -I {} ${pkgs.swaybg}/bin/swaybg -i /home/tht/Pictures/walls/{}";
        }
      ];
      floating.criteria = [
        {
